...
# ビルド時にベースとするイメージを定義
FROM buildpack-deps:bookworm@sha256:57d1e5d7cc87f30b947c549caec00203e162b7eb43c096d656a7b7abd03e2745 AS base-build
ENV PNPM_HOME="/pnpm"
...
FROM gcr.io/distroless/cc-debian12:nonroot@sha256:3c62069321a46fd2fe1072fa2dff4c41deef3055be9de8a80e51bd8354ef893c AS runner
ENV PNPM_HOME="/pnpm"
ENV PATH="$PNPM_HOME:$PATH"
