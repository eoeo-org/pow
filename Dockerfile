...
# ビルド時にベースとするイメージを定義
FROM buildpack-deps:bookworm@sha256:320572fe44d9af57d23b0b75b71737ed9a444c00da8f75e674b728ef944b9eda AS base-build
ENV PNPM_HOME="/pnpm"
...
FROM gcr.io/distroless/cc-debian12:nonroot@sha256:20111f02d53c645d42d68fc2be1c82f471f3b6377063fada1643ef06182214b9 AS runner
ENV PNPM_HOME="/pnpm"
ENV PATH="$PNPM_HOME:$PATH"
